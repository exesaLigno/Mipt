//=================================================================================================================
//           [These sections are for folding control  in Code::Blocks]         [$Date: 2017-10-25 00:00:00 +0400 $]
...
#define _TX_VER      _TX_v_FROM_CVS ($VersionInfo: , TXLib.h, 00173a, 105, 2017-10-25 00:00:00 +0300, "Ded (Ilya Dedinsky, http://txlib.ru) <mail@txlib.ru>", $)
#define _TX_VERSION  _TX_V_FROM_CVS ($VersionInfo: , TXLib.h, 00173a, 105, 2017-10-25 00:00:00 +0300, "Ded (Ilya Dedinsky, http://txlib.ru) <mail@txlib.ru>", $)
#define _TX_AUTHOR   _TX_A_FROM_CVS ($VersionInfo: , TXLib.h, 00173a, 105, 2017-10-25 00:00:00 +0300, "Ded (Ilya Dedinsky, http://txlib.ru) <mail@txlib.ru>", $)
...
#if !defined (_TRUNCATE) || defined (__CYGWIN__)
...
$                  Win32::AddVectoredExceptionHandler (1, (PVECTORED_EXCEPTION_HANDLER)  _txVectoredExceptionHandler);
...
inline bool txOK()
    {
    return (_txCanaryFirst == 0x776F656D &&  // Too well-known values to make them constants. You know them, don't you?
